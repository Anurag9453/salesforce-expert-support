...
export function toExpertApplicationView(record: ExpertApplicationRecord): ExpertApplication {
  return {
    ...
    phone: record.phone,
    trailheadUrl: record.trailheadUrl,
    verifiedCertifications: [...record.verifiedCertifications],
    certificationsVerifiedAt: record.certificationsVerifiedAt?.toISOString() ?? null,
